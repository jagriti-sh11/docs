...
1. On the Infobase home screen, click **+ Add Folder** in the top-right.
2. Enter a name for your folder (for example, `Business` or `Product Docs`).
3. Click **Create** to save the folder.

The new folder appears in your Infobase list. Click the folder to open it — you will add content in the next step.
...
| 2 | Click **+ Add Folder**, name it, and create the folder |
| 3 | Open the folder and click **+ Add Info** |
| 4 | Add a website URL or upload a file |
| 5 | Wait for status to change from **In Progress** to **Ready** |
